...
function weatherSearch(searchValue) {
  ...
  function forecast(lat, lon) {
    ...
    $.ajax({
      ...
      $("#temp2C").text(`Temperature: ${Math.round((response.daily[1].temp.day - 273.15))}°C`);
      ...
      $("#temp3C").text(`Temperature (C): ${Math.round((response.daily[2].temp.day - 273.15))}°C`);
      ...
      $("#temp5C").text(`Temperature: ${Math.round((response.daily[4].temp.day - 273.15))}°C`);
