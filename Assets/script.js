...
<<<<<<< HEAD
        ...
        img.src = "../Style-With-My-Weather-App/images/Winterwm.jpg";
        img.style.height = "500px";
        img.style.width = "500px";
        // CLear the previous content
        document.getElementById("imagePlaceHolder").innerHTML = "";
        document.getElementById("imagePlaceHolder").appendChild(img);
        document.getElementById("backgroundPlaceholder").style.backgroundImage =
            "url('../Style-With-My-Weather-App/images/winter.jpg')";

        var link1 = document.createElement("a");
        link1.target = "_blank";
        link1.href =
            "https://www.amazon.com/s?k=winter+clothes+for+men&ref=nb_sb_noss_1";
        ...
        link2.target = "_blank";
        link2.href =
            "https://www.amazon.com/s?k=winter+clothes+for+women&ref=nb_sb_noss_1";
        ...
        img2.src = "../Style-With-My-Weather-App/images/Springwm.jpg";
        ...
        document.getElementById("backgroundPlaceholder").style.backgroundImage =
            "url('../Style-With-My-Weather-App/images/Spring.jpg')";

        var link1 = document.createElement("a");
        link1.target = "_blank";
        link1.href =
            "https://www.amazon.com/s?k=spring+clothes+for+men&ref=nb_sb_noss_1";
        ...
        link2.target = "_blank";
        link2.href =
            "https://www.amazon.com/s?k=spring+clothes+for+women&ref=nb_sb_noss_1";
        ...
        var img2 = document.createElement("img");
        img2.src = "../Style-With-My-Weather-App/images/Autumnwm.jpg";
        img2.style.height = "500px";
        img2.style.width = "500px";
        // CLear the previous content
        document.getElementById("imagePlaceHolder").innerHTML = "";
        document.getElementById("imagePlaceHolder").appendChild(img2);
        document.getElementById("backgroundPlaceholder").style.backgroundImage =
            "url('../Style-With-My-Weather-App/images/Autumn.jpg')";

        var link1 = document.createElement("a");
        link1.target = "_blank";
        link1.href =
            "https://www.amazon.com/s?k=autumn+clothes+for+men&ref=nb_sb_noss_1";
        ...
        link2.target = "_blank";
        link2.href =
            "https://www.amazon.com/s?k=autumn+clothes+for+women&ref=nb_sb_noss_1";
        ...
        var img2 = document.createElement("img");
        img2.src = "../Style-With-My-Weather-App/images/Summerwm.jpg";
        img2.style.height = "500px";
        img2.style.width = "500px";
        // CLear the previous content
        document.getElementById("imagePlaceHolder").innerHTML = "";
        document.getElementById("imagePlaceHolder").appendChild(img2);
        document.getElementById("backgroundPlaceholder").style.backgroundImage =
            "url('../Style-With-My-Weather-App/images/Summer.jpg')";

        var link1 = document.createElement("a");
        link1.target = "_blank";
        link1.href =
            "https://www.amazon.com/s?k=summer+clothes+for+men&ref=nb_sb_noss_1";
        ...
        link2.target = "_blank";
        link2.href =
            "https://www.amazon.com/s?k=summer+clothes+for+women&ref=nb_sb_noss_1";
...
=======
            ...
            document.getElementById('link2').innerHTML = "";
            container.appendChild(link2);
>>>>>>> e88eae4822e9a8d0f1a4fb41ef1d6be567f395e5
        }
    }
